...
void draw() {
  ...
  noFill();
  stroke(250, 205, 100, 255);
  beginShape();
  curveVertex(width/10, height/10);
  curveVertex(width/10, height/10);
  curveVertex(width/10, height/10 + 30);
  curveVertex(width/10 + 30, height/10 + 10);
  curveVertex(width/10 + 60, height/10 - 30);
  curveVertex(width/10 + 90, height/10 + -10);
  curveVertex(width/10 + 120, height/10 -10);
  curveVertex(width/10 + 120, height/10 - 10);
  endShape();
  
  // squiggly line on right
  stroke(100, 0, 240, 255);
  beginShape();
  curveVertex(width/1.25, height/2);
  curveVertex(width/1.25, height/2);
  curveVertex(width/1.25, height/2 - 30);
  curveVertex(width/1.25 + 20, height/2 - 10);
  curveVertex(width/1.25 + 50, height/2 + 30);
  curveVertex(width/1.25 + 80, height/2 + 10);
  curveVertex(width/1.25 + 120, height/2 + 10);
  curveVertex(width/1.25 + 120, height/2 + 10);
  endShape();
}
